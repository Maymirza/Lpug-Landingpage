...
<div class="container-fluid">
    ...
    <?php if ($user['sap'] == session()->get('npm')) : ?>
        <div class="jumbotron">
    ...
    <?php if ($user['sap'] == 2) : ?>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <form action="/user/usap" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="form-group files">
                        <label class="text">Upload your proof of payment for the course sap
                        </label>
