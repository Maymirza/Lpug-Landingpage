...
<div class="container-fluid">
    ...
    <?php if ($user['cisco_sabtu'] == session()->get('npm')) : ?>
        <div class="jumbotron">
    ...
    <?php if ($user['cisco_sabtu'] == 2) : ?>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                <form action="/user/uciscos" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="form-group files">
                        <label class="text">Upload your proof of payment for the course cisco_sabtu
                        </label>
