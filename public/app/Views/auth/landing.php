...
<link rel="icon" href="/../imagelanding/gunadarma.png"/>
            ...
            <div class="lg:inline-flex lg:flex-wrap lg:flex-row flex flex-col items-center w-full h-auto lg:h-24 my-8 space-y-4 lg:my-0 space-x-0 lg:space-x-10 lg:space-y-0">
              <div class="sm:ml-auto  md:ml-auto flex flex-col lg:flex-row items-center text-base justify-center space-y-4 space-x-0 lg:space-x-10 lg:space-y-0 ">
                ...
                >
                 ...
                 <a href="https://ecourse-lpug.gunadarma.ac.id/login"> <button class="inline-flex items-center justify-center bg-[#700D8B] border-0 rounded-xl w-24 h-8 lg:w-40 lg:h-11 focus:outline-none hover:bg-gray-200 text-white text-sm lg:text-base hover:text-black">
                    Login
                  </button></a>
      ...
      <section class="text-gray-600 body-font overflow-hidden" id="alur">
        <div class="flex flex-col">
          ...
          <div class="flex flex-row">
            ...
            <div class="w-full">
              <img src="/../imagelanding/alur.png" class="w-full max-w-sm lg:max-w-6xl" alt="alurdaftar"/>
            </div>
          </div>
