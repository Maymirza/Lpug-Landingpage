...
<div class="container-fluid">
    ...
    <h1><?= $title ?></h1>
    <form action="/admin/onproveorac" method="post">
        <?= csrf_field(); ?>
    ...
    <form class="user" method="post" action="/admin/adselesaiora">
        <?= csrf_field(); ?>
        <table class="table">
            <thead>
                <tr>
                    ...
                    <tr>
                        ...
                        <th>
                            <div class="form-check">
                                <input class="form-check-input position-static" type="checkbox" name="waitapo[]" value="<?= $o['npm'] ?>">
                            </div>
                        </th>
                    </tr>
                    <?php $i++ ?>
