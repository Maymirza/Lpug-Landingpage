...
<div class="container-fluid">
    ...
    <h1><?= $title ?></h1>
    <form action="/admin/boracle" method="post">
        <?= csrf_field(); ?>
    ...
    <form class="user" method="post" action="/admin/approvebo">
                    ...
                    <tr>
                        ...
                        <th>
                            <div class="form-check">
                                <input class="form-check-input position-static" type="checkbox" name="blankora[]" value="<?= $o['npm'] ?>">
                            </div>
                        </th>
                        <th>
                            <img src="/blanko/<?= $o['npm']  ?>" class="previewoig" data-toggle="modal" data-target="#exampleModalCenter<?= $i ?>">
                        </th>
                    </tr>
